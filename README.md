...
[![Version](https://img.shields.io/badge/version-v1.2.2--server--alpha-236f4e?style=for-the-badge)](https://github.com/littleseven2003/mahjong_scoreboard/releases)
...
当前分支版本：`v1.2.2-server-alpha`。该版本以正式版 `v1.2.2` 为功能基线，额外包含用于公网测试部署的管理员、用户须知和数据管理实验能力，和正式稳定版区分发布。
